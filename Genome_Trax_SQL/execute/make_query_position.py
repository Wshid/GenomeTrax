...
def make_query(hg_version, chr_range):
    for chr_idx in chr_range:
        ...
        for i in range(1, int(pos_limit/pow(10,7))+1):
            ...
            write_sql="CREATE TABLE genometrax_schema.ngs_feature_"+hg_version+"_"+chr_string+"_"+pos_string+" LIKE genometrax_schema.ngs_feature_"+hg_version+"_"+chr_string+";"
            write_sql+="\n" 
            write_sql+="INSERT INTO genometrax_schema.ngs_feature_"+hg_version+"_"+chr_string+"_"+pos_string+" SELECT * FROM genometrax_schema.ngs_feature_"+hg_version+"_"+chr_string+" WHERE "
            if i==1:
...
if __name__=="__main__":
    ...
    #hg_version='hg19'
    #hg_version='hg38'
    input_file_name = "/home/kwangsookim/Documents/cbi_project_memo/Genome_Trax_SQL/execute/list_max_"+hg_version
    output_file_name = "make_query_position_"+hg_version+".sql"
